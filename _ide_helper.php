...
')
     ...
     */ 
         ...
         * @return \Mzcoding\SmsAero\array(response) 
         * @static 
         */ 
        public static function send($to, $text, $date = false, $digital = 0, $type = 2)
        {
                        /** @var \Mzcoding\SmsAero\SmsAero $instance */
                        return $instance->send($to, $text, $date, $digital, $type);
        }
                    /**
         * Отправка по группам
         *
         ...
         * @static 
         */ 
        public static function sendtogroup($group, $text, $digital = 0, $type = 2)
        {
                        /** @var \Mzcoding\SmsAero\SmsAero $instance */
                        return $instance->sendtogroup($group, $text, $digital, $type);
        }
                    /**
         ...
         * @static 
         */ 
        public static function checksending($id)
        {
                        /** @var \Mzcoding\SmsAero\SmsAero $instance */
                        return $instance->checksending($id);
        }
                    /**
         * Запрос баланса
         *
         ...
         * @static 
         */ 
        public static function checktarif()
        {
                        /** @var \Mzcoding\SmsAero\SmsAero $instance */
                        return $instance->checktarif();
        }
                    /**
        ...
        {
                        /** @var \Mzcoding\SmsAero\SmsAero $instance */
                        return $instance->addgroup($group);
        }
                    /**
         * Удаление группы
         *
        ...
        {
                        /** @var \Mzcoding\SmsAero\SmsAero $instance */
                        return $instance->delgroup($group);
        }
                    /**
         ...
         * @static 
         */ 
        public static function addphone($phone, $group = false, $lname = '', $fname = '', $sname = '', $bday = '', $param = '')
        {
                        /** @var \Mzcoding\SmsAero\SmsAero $instance */
                        return $instance->addphone($phone, $group, $lname, $fname, $sname, $bday, $param);
        }
                    /**
         * Удаление контактов
         *
         ...
         * @static 
         */ 
        public static function delphone($phone, $group = false, $lname = '', $fname = '', $sname = '', $bday = '', $param = '')
        {
                        /** @var \Mzcoding\SmsAero\SmsAero $instance */
                        return $instance->delphone($phone, $group, $lname, $fname, $sname, $bday, $param);
        }
                    /**
         ...
         * @static 
         */ 
        public static function addblacklist($phone)
        {
                        /** @var \Mzcoding\SmsAero\SmsAero $instance */
                        return $instance->addblacklist($phone);
        }
...
namespace  { 
            ...
            class SmsAero extends \Mzcoding\SmsAero\SmsAeroFacade {}
